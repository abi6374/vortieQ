  ...
  return (
    <div className="grid grid-cols-2 md:grid-cols-4 gap-4 sm:gap-6 w-full max-w-6xl mx-auto py-8">
      {stats.map((stat, i) => (
        <div
          key={i}
          className="p-6 rounded-2xl border border-[#E0E0E0] dark:border-[#202B3C] bg-white/70 dark:bg-[#111726]/75 backdrop-blur-xl flex flex-col justify-between hover:border-[#0066CC]/40 dark:hover:border-[#38BDF8]/40 transition-all duration-300 shadow-xs hover:shadow-lg group"
        >
          <div className="text-3xl sm:text-4xl md:text-5xl text-[#0066CC] dark:text-[#38BDF8] group-hover:scale-105 transition-transform duration-300 origin-left">
