    ...
    <div className="w-full max-w-[1140px] bg-white dark:bg-[#0E1522] rounded-2xl border border-[#f0f0f0] dark:border-[#202B3C] shadow-[0_14px_38px_rgba(25,49,75,0.08)] dark:shadow-[0_14px_38px_rgba(0,0,0,0.5)] flex flex-col justify-between overflow-hidden transition-colors min-h-[640px]">
      ...
      <div className="pt-6 sm:pt-8 pb-3 px-6 sm:px-10 relative">
        ...
        <div className="text-center mt-2 max-w-2xl mx-auto">
          <div className="inline-flex items-center gap-1.5 px-3 py-1 rounded-full bg-[#eaf2fc] dark:bg-[#132238] border border-[#cfe4fb] dark:border-[#1E3A5F] text-[#0066cc] dark:text-[#38BDF8] text-xs font-bold mb-3">
      ...
      <div className="px-6 sm:px-10 py-4 max-w-3xl mx-auto w-full">
        {syncedData && !showSwitchUser ? (
          ...
          <div className="bg-[#F8FAFD] dark:bg-[#131D2E] border-2 border-[#22A06B] dark:border-[#34D399] rounded-2xl p-6 sm:p-8 shadow-sm transition-all">
            <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4 pb-5 border-b border-[#E6EAF2] dark:border-[#202C3E]">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 mt-5">
              <div className="bg-white dark:bg-[#0E1522] border border-[#E6EAF2] dark:border-[#24334A] rounded-xl p-3.5">
                ...
                <div className="flex flex-wrap gap-1.5">
                  {syncedData.top_languages?.length > 0 ? (
                    syncedData.top_languages.map((lang) => (
                      <span
                        key={lang}
                        className="px-2.5 py-1 rounded-lg bg-[#eaf2fc] dark:bg-[#18263D] text-[#0066cc] dark:text-[#38BDF8] text-xs font-bold border border-[#cfe4fb] dark:border-[#1E3A5F]"
                      >
                        {lang}
                      </span>
                    ))
          ...
          <div className="flex flex-col gap-5">
            {/* Input Card */}
            <div className="bg-[#F8FAFD] dark:bg-[#131D2E] border border-[#E0E6F0] dark:border-[#24334A] rounded-2xl p-6 sm:p-7 shadow-xs">
              ...
              <form onSubmit={handleSyncUsername} className="flex flex-col sm:flex-row items-stretch gap-3">
                <div className="flex-1 flex items-center bg-white dark:bg-[#0E1522] border border-[#D8DFEB] dark:border-[#2D3F59] rounded-xl px-3.5 py-2.5 shadow-2xs focus-within:border-[#0066cc] dark:focus-within:border-[#38BDF8] focus-within:ring-2 focus-within:ring-[#0066cc]/15 transition-all">
                  ...
                  <input
                    ...
                    className="bg-transparent border-0 border-none outline-none focus:outline-none focus:ring-0 text-sm text-[#0E1B38] dark:text-[#F8FAFC] placeholder-[#888888] dark:placeholder-[#64748B] w-full flex-1"
                ...
                <button
                  ...
                  className="px-6 py-2.5 bg-[#0066cc] hover:bg-[#0052a3] text-white text-sm font-bold rounded-xl transition-all cursor-pointer disabled:opacity-50 disabled:cursor-not-allowed flex items-center justify-center gap-2 shadow-xs active:scale-[0.99] flex-none min-w-[140px]"
                >
                  {loading ? (
                    <>
            ...
            <div className="flex items-center gap-3">
              <div className="flex-1 h-px bg-[#E6EAF2] dark:bg-[#202C3E]" />
              <span className="text-xs font-bold text-[#888888] dark:text-[#64748B] uppercase tracking-wider">
                OR
              </span>
              <div className="flex-1 h-px bg-[#E6EAF2] dark:bg-[#202C3E]" />
            </div>
      ...
      <div className="h-[76px] px-6 sm:px-10 border-t border-[#f0f0f0] dark:border-[#1E2638] flex items-center justify-between mt-auto">
        ...
        <div className="flex items-center gap-3">
          ...
          <button
            ...
            className="w-[160px] h-[46px] bg-[#0066cc] hover:bg-[#0052a3] active:scale-[0.99] text-white font-bold rounded-xl shadow-[0_4px_14px_rgba(0,102,204,0.35)] transition-all flex items-center justify-center text-[14.5px] cursor-pointer"
          >
