        ...
        <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-3 pb-3 border-b border-[#eef2f6] dark:border-[#27272F] flex-none">
          ...
          <form onSubmit={handleFormSubmit} className="flex items-center gap-2">
            ...
            <button
              ...
              className="px-3 py-1.5 bg-[#0066cc] dark:bg-[#0066cc] hover:bg-[#004fa3] dark:hover:bg-[#004fa3] text-white dark:text-white font-bold text-xs rounded-xl transition-all disabled:opacity-40 disabled:cursor-not-allowed cursor-pointer"
            >
              Add
            </button>
          </form>
