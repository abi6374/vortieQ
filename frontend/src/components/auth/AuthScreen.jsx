...
html.dark .pfa {
  ...
  --divider: #27272F;
  --app-bd: #27272F;
  --lav-circle: rgba(0, 102, 204, 0.12);
  background:
    radial-gradient(1100px 680px at 8% -8%, rgba(0, 102, 204, 0.06) 0%, transparent 55%),
...
html.dark .pfa .btn-primary {
  ...
  box-shadow: 0 8px 18px rgba(0, 102, 204, 0.3) !important;
}
