...
def create_or_update_profile(
    ...
    try:
        ...
        print(f"[profile router] extraction fallback ({type(err).__name__}: {err})", flush=True)
        extracted = profile_service.build_fallback_profile(payload.goal_text, payload.target_role_override)
